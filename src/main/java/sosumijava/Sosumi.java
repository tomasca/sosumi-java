...
public class Sosumi {
    ...
    public URL getPartition() {
        return partition;
    }

    public void refresh() throws SosumiException {
...
//                LOG.debug(gs.toJson(json));
    ...
    private CloseableHttpResponse postApiCall(String urlFunction, String jsonBody) {
